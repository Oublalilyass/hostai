...
// ── REVIEW REQUESTS ───────────────────────────────────────────
// NOTE: bulk-generate MUST be before /:id routes to avoid Express
//       matching "bulk-generate" as an :id parameter
router.get(   '/reviews',              authenticate, reviews.getReviews);
router.post(  '/reviews/generate',     authenticate, reviews.generateReview);
router.post(  '/reviews/bulk-generate',authenticate, reviews.bulkGenerate);
router.post(  '/reviews/:id/send',     authenticate, reviews.sendReview);
router.put(   '/reviews/:id',          authenticate, reviews.updateReview);
